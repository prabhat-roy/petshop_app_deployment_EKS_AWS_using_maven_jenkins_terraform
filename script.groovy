...
def update () {
         sh '''
                ...
                sed -i "s#873330726955.dkr.ecr.us-east-1.amazonaws.com/petshop-image.*+873330726955.dkr.ecr.us-east-1.amazonaws.com/petshop-image:${BUILD_NUMBER}#" petshop-deployment.yaml
                cat petshop-deployment.yaml
         '''
}
def deploy() {
